...
# %%
# Identificar se a pasta de backup
...
for loja in dicionario_lojas:
    ...
    email.Cc = "programacao.oficial2@gmail.com"
    ...
    # Enviando email com texto em HTML e anexando arquivo
    email.HTMLBody = f"""<p>Bom dia, {nome}</p>
    ...
    <p>Segue aem anexo a planilha com todos os dados para mais detalhes.</p>
...
email.Cc = "programacao.oficial2@gmail.com"
email.Subject = f"Ranking Dia {dia_indicador.day}/{dia_indicador.month}"
email.Body = f"""
Prezados, bom dia
